...
//        rightTalon.setSensorPhase(true);
        ...
        rightTalon.config_kP(PARAM_SLOT, kP, TIMEOUT_MS);
        rightTalon.config_kI(PARAM_SLOT, kI, TIMEOUT_MS);
        rightTalon.config_kD(PARAM_SLOT, kD, TIMEOUT_MS);
        rightTalon.config_kF(PARAM_SLOT, kF, TIMEOUT_MS);
